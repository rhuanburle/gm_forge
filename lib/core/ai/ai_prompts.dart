...
5. NO MARKDOWN: Return plain text only. Do not use bold (**), italics (*), headers (#), bullet points (-), or any other markdown formatting.
...
Return ONLY the text content, nothing else. No labels, no explanations, no markdown formatting (no bold, italics, or headers).
''';
  }
  ...
  static String _getImproveInstruction(AiFieldType fieldType) {
    switch (fieldType) {
      ...
      case AiFieldType.creatureStats:
        return 'Improve these combat stats. Make them clear and table-ready. Use plain text, no markdown. Example format: HP 18, AC 13, ATK +4 (1d6+2), SAVE +2.';
  ...
  static String _getSuggestInstruction(
    ...
    switch (fieldType) {
      ...
      case AiFieldType.creatureStats:
        return 'Generate minimal but usable combat stats in plain text. Example: HP 18, AC 13, ATK +4 (1d6+2), SAVE +2. Add 1-2 notable abilities as short phrases.';
